...
public:
    ...
    inline const QString caption() const { return (!m_Alias.isEmpty()) ? m_Alias : m_Name; }
    inline const QString captionX() const { return (!m_Alias.isEmpty()) ? m_Owner + " " + m_Alias : m_JackID; }
};
