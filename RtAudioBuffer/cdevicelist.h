...
class CDeviceList
{
    ...
    public:
        ...
        int FindFreeID(const QString& Name) const;
        ...
        bool CanConnect(const int J1, const int J2);
        bool CanConnect(IJack* J1, IJack* J2);
        bool Connect(IJack* J1, IJack* J2);
        bool Connect(const int J1, const int J2);
        bool Connect(const QString& J1, const QString& J2);
        void Disconnect(const int J1, const int J2);
        void Disconnect(const QString& J1, const QString& J2);
        bool IsConnected(const int J1, const int J2);
        bool IsConnected(const QString& J1, const QString& J2);
        bool IsConnected(IJack* J1, IJack* J2);
        ...
        int IndexOfDevice(IDevice* D) const;
};
#endif // CDEVICELIST_H
